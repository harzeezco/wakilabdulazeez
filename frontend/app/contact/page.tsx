...
const formSchema = z
  .object({
    name: z.string().regex(/^[\s'A-Za-z-]{4,50}$/, {
      ...
      message: 'Your full name must not be longer than 20 characters.',
    }),
...
export function SignupFormDemo() {
  ...
  return (
    <div className='shadow-input border-dark-400/20 mx-auto mt-16 w-full max-w-4xl rounded-3xl border border-solid bg-[#14142B] p-4 md:p-8'>
    ...
    <div className=''>
      <div className="bg-grid-white/[0.05] after:bg-grid-white/[0.02] relative pb-10 after:absolute after:inset-0 after:z-[-2] after:content-['']">
        ...
        <header className='pt-32'>
          <h1 className='bg-gradient-to-b from-neutral-200  to-neutral-600 bg-clip-text text-center text-lg font-bold uppercase tracking-[0.2em] text-transparent md:text-6xl lg:text-9xl'>
            Contact Me
          </h1>
        </header>
      </div>
