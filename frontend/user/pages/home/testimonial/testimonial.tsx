...
export function Testimonial() {
  return (
    <div className='dark:bg-grid-white/[0.05] relative mt-10 flex flex-col items-center justify-center overflow-hidden rounded-md bg-white antialiased dark:bg-black'>
      <InfiniteMovingCards
        direction='right'
        speed='slow'
      >
        {testimonials.map((item) => (
          <li
            key={item.name}
            className='relative h-[300px] w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-slate-700 bg-[#171717] px-8 py-6 md:w-[450px]'
          >
            <blockquote>
              <div
                aria-hidden='true'
